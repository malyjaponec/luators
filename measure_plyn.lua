...
-- Generalizovana citaci funkce
	...
	tuto funkci je potreba prevzit z elektro, provadel jsem tam optimalizace algoritmu
...
-- Uprava vykonu pokud se nic nedeje
    local function ZpracujPauzu()
		funkci je potreba prevzit z elektromeru, pokousim se tam o vylepseni algoritmu
